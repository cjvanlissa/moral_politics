...
we noticed that the model did not converge in one of the datasets (NL).
We examined individual CFAs for the included scales to determine potential
sources of misspecification.
These analyses, summarized below, indicate that several scales in that dataset
displayed evidence of not being unidimensional,
had poor reliability, or had no factors with Eigenvalues greater than would be expected by random chance.
